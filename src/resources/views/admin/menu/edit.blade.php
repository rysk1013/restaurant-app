                    ...
                    <div class="bg-white py-6 sm:py-8 lg:py-12">
                        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                            ...
                            <div class="mb-10 md:mb-16">
                                <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-6">編集</h2>
                            </div>
                            <!-- text - end -->

                            <!-- form - start -->
                            <form action="{{ route('menu.edit.confirm', ['id' => $id]) }}" method="post" class="max-w-screen-md grid sm:grid-cols-2 gap-4 mx-auto" novalidate>
                                @csrf
                                <div class="sm:col-span-2">
                                    <label for="menu_name" class="inline-block text-gray-800 text-sm sm:text-base mb-2">ID</label>
                                    <input disabled type="text" name="menu_name" value="{{ $id }}" class="w-full bg-gray-400 text-gray-50 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                                    <input type="hidden" name="menu_name" value="{{ $id }}" class="w-full text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="menu_name" value="{{ old('menu_name', $menu['name']) }}" class="w-full text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                                </div>
                                ...
                                <div class="sm:col-span-2 text-gray-800">
                                    ...
                                    <select name="subcategory" class="block w-full mt-1 rounded-md border shadow-sm focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2">
                                        @foreach ($subcategories as $key => $val)
                                            <option value="{{ $key }}" @selected(old('subcategory', $menu['menu_subcategory_id']) == $key)>{{ $val['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="turn" value="{{ old('turn', $menu['turn']) }}" class="w-full text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="price" value="{{ old('price', $menu['price']) }}" class="w-full text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                                </div>

                                <div class="sm:col-span-2">
                                    <label for="description" class="inline-block text-gray-800 text-sm sm:text-base mb-2">説明</label>
                                    <textarea name="description" class="w-full text-gray-800 h-64 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2">{{ old('description', $menu['description']) }}</textarea>
                                </div>
